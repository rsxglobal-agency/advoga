                                              ...
                                              <div class="activity-body act-in" data-id="{{$demand['id']}}">
                                                  ...
                                                  <div class="text">
                                                      <a href="#" class="activity-img">
                                                         @if($user["img"]!='')   
                                                             <img alt="" src="{{ $user['img'] }}" height="500" width="500"/>
                                                         @else
                                                            <img alt="" src="{{ URL::to('/img/avatar/default.jpg') }}" height="500" width="500"/>
                                                         @endif
                                                      </a>
                                                      <p class="attribution"><a href="#">{{$user["nome"]}}</a>  <br>
                                                      ...
                                                      <tr><br>
                                                          ...
                                                          <th><strong> {{ $demand["name"]}}</strong></th><br>
                                                                                           ...
                                                                                           <th>                                                          
                                                          <p class="attribution"><i class="icon_pin_alt"></i>{{ $demand["state_id"]}}, {{ $demand["city_id"]}}</span> - <i class="icon_calendar"></i> {{ $demand["created_at"]}} - <i class="icon_clock"></i> {{ $demand["created_at"]}}</p>
                                                      ...
                                                      <li class="btn btn-default btn-sm">
                                                            <a href="#" 
                                                               ...
                                                               data-user="{{Auth::user()}}"
                                                               data-demand='{"id":"{{$demand["id"]}}","name":"{{$demand["name"]}}","executor_id":"{{$demand["executor_id"]}}","user_name":"{{$user["nome"]}}","user_id":"{{$user["id"]}}"}' 
                                                               data-to    ='{"id":"{{$user["id"]}}","nome":"{{$user["nome"]}}"}'
                                                               class="btn-open-chat">
