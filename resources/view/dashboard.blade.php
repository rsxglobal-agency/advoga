  ...
  <!--teste leo-->
    <div class="flex-profile" id="flex-profile">
      <div class="flex-photo-header" id="flex-photo-header">
         ...
         @if(Auth::user()->image!='')   
             <img alt="I" src="{{ Auth::user()->image }}" width="150"   id="profile_user_image"/>
         @else
            <img alt="I" src="{{ URL::to('/img/avatar/default.jpg') }}" width="150"   id="profile_user_image"/>
         @endif
          </div>
                     ...
                     <div class="activity-body act-in" data-id="{{$demand->id}}">
                         ...
                         <div class="text">
                             ...
                             <a href="#" 
                                ...
                                <?php
                                  $photo = $demand->user->image;
                                  $splited = str_split($photo, 61);
                                  $url = "https://storage.googleapis.com/advogaapp.appspot.com/avatars/";
                                  if($photo != ''){
                                    if(sizeof($splited) > 0 && $splited[0] === $url){
                                      echo '<img alt="user_photo" src="'.$demand->user->image.'" height="500" width="500"/>';
                                    }else{
                                      echo '<img alt="user_photo" src="'.URL::to('uploads/avatars').'/'.$demand->user->image.'" height="500" width="500"/>';
                                    }
                                  }else{
                                    echo '<img alt="user_photo" src="'.URL::to('/img/avatar/default.jpg').'" height="500" width="500"/>';
                                  }
                                ?>
                             </a>
