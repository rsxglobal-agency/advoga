...
<!-- user login dropdown start-->
    ...
    <span class="profile-ava">
         @if(Auth::user()->image!='')   
             <img alt="" src="{{URL::to('/uploads/avatars')}}/{{ Auth::user()->image }}" height="30" width="30"/>
         @else
            <img alt="" src="{{ URL::to('/img/avatar/default.jpg') }}" height="30" width="30"/>
         @endif
    </span>
  ...
  <div class="log-arrow-up"></div>
    ...
    <a href="{{ URL::to('/atualizar-cadastro') }}"><i class="icon_toolbox"></i>Editar Perfil</a>
    </li>
