...
<!-- INÍCIO do Formulário -->
 ...
 <div class="panel-body">
    ...
    @endif
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal" method="POST" action="{{ URL::to('/atualizar-cadastro') }}"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-5">
                                        ...
                                        <div class="col-lg-5">
                                                @if($user->image!='')   
                                                     <img alt="" src="{{ URL::to('/uploads/avatars') }}/{{$user->image}}" style="width:80px;height: auto;"/>
                                                @endif
                                       </div>    
                                    </div>
...
<!-- INÍCIO Seleção de estado -->
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-3">
                                          {!! Form::select('state_id', App\State::pluck('name', 'id'), $user->state_id, ['class'=>'form-control selectpicker','id'=>"state_id",'data-cidade'=>"$user->city_id", 'placeholder'=>'Selecione um Estado', 'required' ]); !!}
                                      </div> 
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Cidade:</label>
                                         <div class="col-lg-3">
                                          {!! Form::select('city_id', App\City::pluck('name', 'id'), $user->city_id, ['class'=>'form-control selectpicker','id'=>"city_id",'data-cidade'=>"$user->city_id", 'placeholder'=>'Selecione um Estado', 'required' ]); !!}
                                       </div>
                                    </div>
...
<!-- FIM Seleção de estado -->
                                    ...
                                    <!-- INÍCIO da Titulação -->
                                      ...
                                      @if(!(Auth::user()->titulation_id===5))

                                      <div class="form-group">
                                      <label class="control-label col-lg-2" for="inputSuccess">Titulação:</label>
                                      <div class="col-lg-3">
                                      {!! Form::select('titulation_id', App\Titulation::pluck('name', 'id'), $user->titulation_id, ['class'=>'form-control selectpicker', 'placeholder'=>'Selecione uma Titulação' ]); !!}
                                          </div></div>
...
<!-- INÍCIO da Formação -->
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-3">
                                      {!! Form::select('formation_id', App\Formation::pluck('name', 'id'),$user->formation_id, ['class'=>'form-control selectpicker', 'placeholder'=>'Selecione uma Formação' ]); !!}
...
<div class="form-group">
  ...
  <table align="left" width=850 height=100><tr><td>
       ...
       <textarea class="form col-lg-10" name="description" maxlength="200" placeholder="Olá, meu nome é fulano e trabalho em uma determinada área.">{{$user->description}}</textarea>
...
<table align="left" width=850 height=100><tr><td>
     <textarea class="form col-lg-10" name="social" maxlength="200" placeholder="linkedin.com/fulanodetal">{{$user->social}}</textarea><br/>
