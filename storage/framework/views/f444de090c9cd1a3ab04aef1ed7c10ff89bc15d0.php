                              ...
                              <div class="form">
                                  ...
                                  <?php echo Form::open(['route' => 'user.store','files'=>true,'id'=>"formCadastro",'class'=>"form-validate form-horizontal"]); ?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-3">
                                          <?php echo Form::select('state_id', App\State::pluck('name', 'id'), null, ['class'=>'form-control selectpicker', 'placeholder'=>'Selecione um Estado', 'required' ]);; ?>
                                    ...
                                    <!-- INÍCIO da Titulação -->
                                      ...
                                      <div class="col-lg-3">
                                      <?php echo Form::select('titulation_id', App\Titulation::pluck('name', 'id'), null, ['class'=>'form-control selectpicker', 'placeholder'=>'Selecione uma Titulação', 'required' ]);; ?>
                                      ...
                                      <div class="col-lg-3">
                                      <?php echo Form::select('formation_id', App\Formation::pluck('name', 'id'), null, ['class'=>'form-control selectpicker', 'placeholder'=>'Selecione uma Formação','required' ]);; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <?php echo $__env->make('includes.termos', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<div class="modal fade modal-lg" tabindex="-1" role="dialog" id="politica-privacidade">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
           <?php echo $__env->make('includes.politica', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script>
   ...
   function register(){
      $.post("<?php echo e(route('user.store')); ?>", $("#formzera").serialize() , function (data) {
      ...
      //    window.location.href="<?php echo e(asset('redirectpath')); ?>";
       //   return;
       // }
          

     //   var url="<?php echo e(asset('user/pagamento')); ?>/"+id;
