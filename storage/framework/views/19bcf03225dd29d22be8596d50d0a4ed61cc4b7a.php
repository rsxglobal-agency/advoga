...
<!-- INÍCIO Seleção de estado -->
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-3">
                                          <?php echo Form::select('state_id', App\State::pluck('name', 'id'), $user->state_id, ['class'=>'form-control selectpicker','id'=>"state_id",'data-cidade'=>"$user->city_id", 'placeholder'=>'Selecione um Estado' ]);; ?>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-lg-2" for="inputSuccess">Cidade:</label>
                                          ...
                                          */ ?>
                                          <?php echo Form::select('city_id', App\City::pluck('name', 'id'), $user->city_id, ['class'=>'form-control selectpicker','id'=>"city_id",'data-cidade'=>"$user->city_id", 'placeholder'=>'Selecione um Estado' ]);; ?>
...
<table align="left" width=850 height=100><tr><td>
     <textarea class="form col-lg-10" name="social" maxlength="200" placeholder="linkedin.com/fulanodetal"><?php echo e($user->description); ?></textarea><br/>
