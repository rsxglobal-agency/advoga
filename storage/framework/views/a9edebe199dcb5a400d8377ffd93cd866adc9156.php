                   ...
                   <div class="chat-item" id="chat-item">              
                     ...
                     <div class="flex-item" id="flex-item">
                       <div class="circular--portrait" id="circular--portrait-chat"> 
                          <?php if($conv->other->image!=''): ?>  
                            <img alt="" src="<?php echo e(URL::to('/uploads/avatars')); ?>/<?php echo e($conv->other->image); ?>"  id="chat_user_image" height="150">
                              <?php else: ?> 
                              <img alt="" src="<?php echo e(URL::to('/img/avatar/default.jpg')); ?>"  id="chat_user_image" height="150" >
                              <?php endif; ?>
                      
                       </div>                    
                       <div class="flex-textos" id="flex-textos">
                          <p class="nome" id="nome"><?php echo e($conv->other->name); ?></p>
                          <p class="demanda" id="demanda">Demanda</p>
                          <?php if($conv->demand!=null): ?>                                                                                         
                           <p class="demanda-nome" id="demanda-nome"><?php echo e($conv->demand->name); ?></p>
                          <?php elseif($conv->demand==null): ?>
