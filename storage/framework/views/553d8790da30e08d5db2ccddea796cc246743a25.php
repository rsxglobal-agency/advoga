                                           ...
                                           <?php $__currentLoopData = $demands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $demand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <div class="activity-body act-in" data-id="<?php echo e($demand->id); ?>">
                                                  ...
                                                  <div class="text">
                                                      ...
                                                      <li class="btn btn-default btn-sm"><a href="#" class="btn-concluir-demanda" data-user-id="<?php echo e($demand->user_id); ?>"  data-id="<?php echo e($demand->id); ?>"><font color="green"><i class="icon_check"><font color="black"></i> Concluída</font></font></a></li>
                                                      ...
                                                      <li class="btn btn-default btn-sm"><a class="btn-desistir-demanda" href="#" data-cancelar="desistirdemanda" data-id="<?php echo e($demand->id); ?>"><font color="black"><i class="icon_trash" ></i> Cancelar</a></font></li>
                                                         </td>
                                                       </div>
                                                  </div>
                                              </div><br>
