...
Demanda lançada com sucesso!
 ...
 --> 
    ...
    <div class="panel-body">
     ...
     <?php echo Form::open(['route' => 'demands.store', 'class'=>"form-validate form-horizontal"]); ?>
...
<div class="row">
  ...
  <!-- INÍCIO Seleção de estado -->
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-3">
                                          <?php echo Form::select('state_id', App\State::pluck('name', 'id'), null, ['class'=>'form-control selectpicker','id'=>'state_id', 'placeholder'=>'Selecione um Estado' ]);; ?>
...
<div>
  ...
  <textarea class="form-control" id="description" name="description" placeholder="Descrição da demanda"></textarea>
